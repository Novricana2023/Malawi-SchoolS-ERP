        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentStreamId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Students_Streams_CurrentStreamId",
                        column: x => x.CurrentStreamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSummaries_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceSummaries_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookBorrowings_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookBorrowings_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookReservations_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookReservations_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Offense = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Type = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DisciplineRecords_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    CurrentGrade = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanAccessAttendance = table.Column<bool>(type: "bit", nullable: false),
                    CanAccessFees = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AnnouncementRecipients_Parents_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Parents",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AnnouncementRecipients_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AnnouncementRecipients_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LateSubmissionPenaltyPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MaxAttempts = table.Column<int>(type: "int", nullable: false),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscussionPosts_DiscussionForums_ForumId",
                        column: x => x.ForumId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignmentRubrics_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnsweredQuestions_ExamQuestions_ExamQuestionId",
                        column: x => x.ExamQuestionId,
                        principalTable: "ExamQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AnsweredQuestions_ExamResults_ExamResultId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RubricLevels_AssignmentRubrics_RubricId",
                        column: x => x.RubricId,
                        principalTable: "AssignmentRubrics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubmissionComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SubmissionComments_AssignmentSubmissions_SubmissionId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SubmissionComments_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementRecipients_ParentId",
                table: "AnnouncementRecipients",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementRecipients_StudentId",
                table: "AnnouncementRecipients",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementRecipients_TeacherId",
                table: "AnnouncementRecipients",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnsweredQuestions_ExamQuestionId",
                table: "AnsweredQuestions",
                column: "ExamQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_AnsweredQuestions_ExamResultId",
                table: "AnsweredQuestions",
                column: "ExamResultId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSummaries_ClassId",
                table: "AttendanceSummaries",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSummaries_SubjectId",
                table: "AttendanceSummaries",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookBorrowings_StudentId",
                table: "BookBorrowings",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_BookBorrowings_TeacherId",
                table: "BookBorrowings",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookReservations_StudentId",
                table: "BookReservations",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_BookReservations_TeacherId",
                table: "BookReservations",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DisciplineRecords_TeacherId",
                table: "DisciplineRecords",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscussionPosts_ForumId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_CurrentStreamId",
                table: "Students",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmissionComments_TeacherId",
                table: "SubmissionComments",
                column: "TeacherId");
